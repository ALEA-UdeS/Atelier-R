...
1. Calculer l'abondance totale (ou encore le nombre total) de joueur pour chacune des positions, leur abondance moyenne par équipe et le coefficient de variation de leur abondance ;
2. Calculer le nombre total de joueurs par équipe ;
3. Transformer l'abondance absolue (ou encore le nombre total) en abondance relative ;
