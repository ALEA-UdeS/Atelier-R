...
# Nombre de joueur moyen par equipe
moy <- mean(X)
# Nombre total de joueur
tot <- sum(X)
# Coefficient de variation de l'abondance
CV <- sd(X)/mean(X)
# Distribution relative de joueur par equipe
DistRel <- X/tot  
# Pourcentage minimum de joueur dans une equipe
PourcMin <- min(DistRel)
# Pourcentage maximum de joueur dans une equipe
PourcMax <- max(DistRel)
...
apply(PositionEquipe, 2, ma_fonction)
...
- Est-ce qu'il y a un as sur le dessus du paquet de cartes?
