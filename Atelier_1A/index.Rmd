...
```{r eval=FALSE}
setwd("/home/morj2519/Documents/ALEA/H2020/ALEA - R/Atelier_1A")
```

- Pour les utilisateurs Windows:

```{r eval=FALSE}
setwd("c:/morj2519/Documents/ALEA/H2020/ALEA - R/Atelier_1A")
```
...
L'opérateur `c` est appelé l'opérateur de `concaténation`.
